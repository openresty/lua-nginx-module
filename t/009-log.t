...
after log
--- error_log eval
qr/\[\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[emerg\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[alert\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[crit\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[error\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[warn\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[notice\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[info\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[debug\] \S+: \S+ \[string "content_by_lua"\]:3: hello, log12343.14159/
...
after log
--- error_log eval
qr/\[notice\] \S+: \S+ lua print: \[string "content_by_lua"\]:3: hello, log12343.14159/
...
--- error_log eval
[
'lua print: [string "content_by_lua"]:2: ,',
'lua print: [string "content_by_lua"]:3: nil,',
'lua print: [string "content_by_lua"]:4: nil: nil,',
]
...
32
--- error_log eval
qr/\[error\] \S+: \S+ \[string "set_by_lua"\]:2: HELLO,/
...
32
--- error_log eval
qr/\[error\] \S+: \S+ \[string "set_by_lua"\]:2: truefalsenil,/
...
foo: 32
--- error_log eval
qr/\[notice\] .*? lua print: \[string "header_filter_by_lua"\]:2: hello world/
--- response_body
hi
...
hi
--- error_log eval
qr/\[error\] .*? \[string "header_filter_by_lua"\]:2: howdy, lua!/
...
--- error_log eval
qr/\[error\] \S+: \S+ \[string "content_by_lua"\]:7: bar\(\): hello, log12343.14159/
...
--- error_log eval
qr/\[error\] \S+: \S+ \[string "content_by_lua"\]:8: hello, log12343.14159/
...
--- error_log eval
qr/\[error\] \S+: \S+ test.lua:6: bar\(\): hello, log12343.14159/
