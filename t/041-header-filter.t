...
=== TEST 6: use variable generated by content phrase
--- config
   location /read {
        set $strvar '1';
        content_by_lua '
...
=== TEST 7: use variable generated by content phrase for HEAD
--- config
   location /read {
        set $strvar '1';
        content_by_lua '
...
=== TEST 8: use variable generated by content phrase for HTTP 1.0
--- config
   location /read {
        set $strvar '1';
        content_by_lua '
...
=== TEST 9: use capture and header_filter_by
--- config
   location /sub {
        content_by_lua '
            ngx.say("Hi");
...
=== TEST 13: set response content-type header (by file)
--- config
    location /read {
        echo "Hi";
