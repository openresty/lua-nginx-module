...
#ifndef NGX_HTTP_LUA_HEADER_FILTER_BY_H
#define NGX_HTTP_LUA_HEADER_FILTER_BY_H
...
ngx_int_t ngx_http_lua_header_filter_by_chunk(lua_State *L, ngx_http_request_t *r);
...
#endif /* NGX_HTTP_LUA_HEADER_FILTER_BY_H */
